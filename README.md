...
alpine|alpine Linux v3.14|[![ghcr build status](https://github.com/mbhangui/docker/actions/workflows/indimail-mta-alpine.yml/badge.svg)](https://github.com/mbhangui/docker/actions/workflows/indimail-mta-alpine.yml)|[![ghcr build status](https://github.com/mbhangui/docker/actions/workflows/indimail-alpine.yml/badge.svg)](https://github.com/mbhangui/docker/actions/workflows/indimail-alpine.yml)|<!---[![ghcr build status](https://github.com/mbhangui/docker/actions/workflows/indimail-web-alpine.yml/badge.svg)](https://github.com/mbhangui/docker/actions/workflows/indimail-web-alpine.yml)---> TODO
